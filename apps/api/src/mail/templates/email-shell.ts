...
/**
 * The header/brand-stripe/footer chrome shared by every transactional email
 * this app sends. A caller supplies the subject/preheader, the heading, and
 * the body content (already-built HTML, e.g. a quote box or a details
 * table) that goes between the greeting and the closing CTA button.
 */
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    <td align="center" style="border-radius:10px;background-color:${BRAND.blue};">
                      <a href="${ctaHref}" style="display:inline-block;padding:13px 28px;font-family:Arial,Helvetica,sans-serif;font-size:14px;font-weight:700;color:#ffffff;text-decoration:none;border-radius:10px;">
                        ${ctaLabel}
                      </a>
                    </td>
                  </tr>
            ...
            <tr>
              <td style="padding:20px 40px 36px 40px;background-color:${BRAND.surfaceMuted};font-family:Arial,Helvetica,sans-serif;">
                ...
                <p style="margin:0;font-size:11px;color:${BRAND.ink3};">
                  ...
                  receiving it because this address was used on our site.
                </p>
              </td>
            </tr>
          </table>
