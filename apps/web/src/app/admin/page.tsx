...
import { fetchFormsAdminList } from "@/lib/forms/admin-server";
...
export default async function AdminPage() {
  ...
  const [
    ...
    can(session.permissions, "forms", "read")
      ? fetchFormsAdminList().catch(() => [])
      : Promise.resolve([]),
  ]);
  return (
    <MemberCmsStudio
      ...
      initialContactInquiries={contactInquiries ?? []}
