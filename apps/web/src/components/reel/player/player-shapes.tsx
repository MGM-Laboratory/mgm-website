...
export const BURST: { kind: BitKind; color: string; size: number }[] = [
  { kind: "circle", color: TONES[0], size: 25 },
  { kind: "triangle", color: TONES[1], size: 28 },
  { kind: "plus", color: TONES[2], size: 25 },
  { kind: "square", color: TONES[3], size: 20 },
  { kind: "half", color: TONES[0], size: 31 },
  { kind: "x", color: TONES[1], size: 22 },
  { kind: "leaf", color: TONES[2], size: 25 },
  { kind: "star", color: TONES[0], size: 31 },
  { kind: "circle", color: TONES[2], size: 17 },
  { kind: "triangle", color: TONES[3], size: 22 },
  { kind: "plus", color: TONES[0], size: 20 },
  { kind: "square", color: TONES[1], size: 17 },
  { kind: "half", color: TONES[3], size: 22 },
  { kind: "leaf", color: TONES[1], size: 20 },
  { kind: "x", color: TONES[3], size: 17 },
  { kind: "circle", color: TONES[1], size: 14 },
  { kind: "star", color: TONES[2], size: 22 },
  { kind: "square", color: TONES[0], size: 14 },
];
